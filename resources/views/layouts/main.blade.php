...
<body>
    <div id="app">
                    ...
                    <div class="collapse navbar-collapse" id="edicaMainNav">
                        <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                            ...
                            <form method="POST" action="{{route('logout')}}">
                                @csrf
                                <li class="nav-item">
                                    <input class="nav-link border-0 bg-white text-dark" type="submit" value="Вийти">
                                </li>
                            </form>
                            @endauth                        
                        </ul>                   
        ...
        <script type="application/javascript" src="{{asset('assets/vendors/popper.js/popper.min.js')}}"></script>
        <script type="application/javascript" src="{{asset('assets/vendors/bootstrap/dist/js/bootstrap.min.js')}}"></script>
        <script type="application/javascript" src="{{asset('assets/vendors/aos/aos.js')}}"></script>
